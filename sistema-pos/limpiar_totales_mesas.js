...
async function limpiarTotalesMesas() {
  try {
    console.log('🧹 [LIMPIEZA DE TOTALES] Iniciando...\n');
    ...
    // 2. Limpiar totales acumulados de mesas libres
    ...
    console.log(`✅ Mesas limpiadas: ${limpiarResult.rowCount}`);
