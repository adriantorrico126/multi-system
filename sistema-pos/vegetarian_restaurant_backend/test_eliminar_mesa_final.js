...
/**
 * Script final para probar la eliminación de mesas con la estructura correcta
 * Ejecutar con: node test_eliminar_mesa_final.js
 */
...
async function testEliminarMesaFinal() {
  ...
  try {
    ...
    console.log(`✅ Mesa encontrada: ID ${mesa.id_mesa}, Número ${mesa.numero}, Restaurante ${mesa.id_restaurante}`);
      ...
      try {
        ...
        if (deleteResult.rows.length > 0) {
          ...
          await client.query(`
            ...
            VALUES ($1, $2, $3, $4, $5)
            RETURNING id_mesa
          `, [mesa.numero, 1, 4, 'libre', mesa.id_restaurante]);
