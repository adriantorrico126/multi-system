...
router.get('/activas', authenticateToken, authorizeRoles('admin', 'cajero', 'super_admin', 'cocinero', 'mesero'), ensureTenantContext, promocionController.getPromocionesActivas);
...
router.post('/calcular-descuento', authenticateToken, authorizeRoles('admin', 'cajero', 'super_admin', 'cocinero', 'mesero'), ensureTenantContext, promocionController.calcularDescuento);

// Aplicar descuentos a productos
router.post('/aplicar-descuentos', authenticateToken, authorizeRoles('admin', 'cajero', 'super_admin', 'cocinero', 'mesero'), ensureTenantContext, promocionController.aplicarDescuentosAProductos);
...
router.get('/producto/:id_producto/verificar', authenticateToken, authorizeRoles('admin', 'cajero', 'super_admin', 'cocinero', 'mesero'), ensureTenantContext, promocionController.tienePromocionesActivas);
