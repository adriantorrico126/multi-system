...
async function migrateEgresosCorrected() {
  const client = await pool.connect();
  
  try {
    console.log('🚀 Iniciando migración corregida del sistema de egresos...\n');
    ...
    const commands = [
      ...
      // 2. Crear tabla egresos corregida
      ...
      `CREATE INDEX IF NOT EXISTS idx_egresos_registrado_por ON egresos(registrado_por)`,
    ...
    console.log('\n🎉 Migración corregida del sistema de egresos completada exitosamente!');
...
module.exports = { migrateEgresosCorrected };
