-- Migración: 001_add_pago_diferido_tables_fixed.sql
-- Descripción: Agregar tablas y columnas para el sistema de pago diferido (versión corregida)
-- Fecha: 2025-01-09
-- Autor: Sistema POS
...
COMMENT ON COLUMN pagos_diferidos.mesa_numero IS 'Número de la mesa';
...
CREATE INDEX IF NOT EXISTS idx_pagos_diferidos_mesa_numero ON pagos_diferidos(mesa_numero);
...
CREATE INDEX IF NOT EXISTS idx_historial_pagos_diferidos_mesa_numero ON historial_pagos_diferidos(mesa_numero);
