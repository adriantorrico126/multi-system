...
Este script asegura que las prefacturas solo muestren datos de la sesión actual.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('fix_prefactura_produccion.log', encoding='utf-8'),
...
def main():
    """Función principal"""
    logger.info("🚀 Iniciando corrección de prefacturas en producción")
    ...
    try:
        ...
        sql_file_path = 'sistema-pos/database-migrations/fix_prefactura_produccion.sql'
