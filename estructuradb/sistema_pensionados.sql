...
CREATE TABLE IF NOT EXISTS pensionados (
    ...
    CONSTRAINT fk_pensionados_restaurante FOREIGN KEY (id_restaurante) REFERENCES restaurantes(id_restaurante),
    CONSTRAINT fk_pensionados_sucursal FOREIGN KEY (id_sucursal) REFERENCES sucursales(id_sucursal),
    CONSTRAINT fk_pensionados_created_by FOREIGN KEY (created_by) REFERENCES usuarios(id_usuario),
...
CREATE TABLE IF NOT EXISTS consumo_pensionados (
    ...
    CONSTRAINT fk_consumo_pensionado FOREIGN KEY (id_pensionado) REFERENCES pensionados(id_pensionado),
    CONSTRAINT fk_consumo_restaurante FOREIGN KEY (id_restaurante) REFERENCES restaurantes(id_restaurante),
    CONSTRAINT fk_consumo_mesa FOREIGN KEY (id_mesa) REFERENCES mesas(id_mesa),
    CONSTRAINT fk_consumo_venta FOREIGN KEY (id_venta) REFERENCES ventas(id_venta),
    CONSTRAINT fk_consumo_mesero FOREIGN KEY (mesero_asignado) REFERENCES usuarios(id_usuario),
...
CREATE TABLE IF NOT EXISTS prefacturas_pensionados (
    ...
    CONSTRAINT fk_prefactura_pensionado FOREIGN KEY (id_pensionado) REFERENCES pensionados(id_pensionado),
    CONSTRAINT fk_prefactura_restaurante FOREIGN KEY (id_restaurante) REFERENCES restaurantes(id_restaurante),
...
INSERT INTO pensionados (
    ...
    incluye_almuerzo, incluye_cena, max_platos_dia,
    descuento_aplicado, estado, created_by
) VALUES 
(
    1, 1, 'Juan Pérez', 'individual',
    '12345678', '70123456', 'juan.perez@email.com',
    CURRENT_DATE, CURRENT_DATE + INTERVAL '1 month', 'meses', 1,
    true, false, 1,
    10.00, 'activo', 1
),
(
    1, 1, 'Empresa ABC S.A.', 'corporativo',
    '1234567890', '70123456', 'contabilidad@empresaabc.com',
    CURRENT_DATE, CURRENT_DATE + INTERVAL '3 months', 'meses', 3,
    true, true, 2,
    15.00, 'activo', 1
);
*/
